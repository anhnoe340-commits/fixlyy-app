...
-- RETURNS TABLE déclare un OUT param implicite "id" qui entre en conflit
-- avec les références non qualifiées à "id" dans le corps de la fonction.
-- Fix : qualifier toutes les références "id" avec leur nom de table.
-- ─────────────────────────────────────────────────────────────────────────────
